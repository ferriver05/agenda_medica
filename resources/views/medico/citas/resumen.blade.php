        ...
        <section class="mb-12">
            ...
            <div id="citasPendientes" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach ($citasPendientes as $cita)
                    ...
                    <div
                        class="cita bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 border-l-4 @if ($estaVencida) border-red-500 @else border-yellow-500 @endif">
                        <div class="flex justify-between items-start mb-2">
                            <h3 class="text-xl font-semibold text-gray-700">{{ $cita->paciente->user->name }}</h3>
                            <span
                                class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium @if ($estaVencida) bg-red-100 text-red-800 @else bg-yellow-100 text-yellow-800 @endif">
                                <svg class="h-4 w-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                    @if ($estaVencida)
                                        <path fill-rule="evenodd"
                        ...
                        <div class="mt-3 flex justify-between items-center">
                            ...
                            @if (!$estaVencida && $diasRestantes <= 7 && $diasRestantes >= 0)
                                <span
                                    class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium @if ($diasRestantes <= 3) bg-red-100 text-red-800 @else bg-yellow-100 text-yellow-800 @endif mb-2">
                                    <svg class="h-4 w-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                                            d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z"
                                            clip-rule="evenodd" />
