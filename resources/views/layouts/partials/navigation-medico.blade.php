        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('medico.dashboard')" :active="request()->routeIs('medico.dashboard')">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                    <x-nav-link :href="route('medico.historial')" :active="request()->routeIs('medico.historial')">
                        {{ __('Historial') }}
                    </x-nav-link>
                </div>
            </div>
